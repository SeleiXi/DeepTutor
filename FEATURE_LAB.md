...
Feature Lab runs the six independent SeleiXi feature branches at the same time.
...
starts all six variants in the background, waits for their backend and frontend
...
Pass a variant key, the full branch name, or omit variants to target all six.
